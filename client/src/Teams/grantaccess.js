...
const Requestaccess = () => {
    ...
    console.log(ID._id);
    const getrows = async () => {
        const rows_fetch = await axios.get(`${process.env.REACT_APP_URL}/team/getrequests/${ID._id}`);
    ...
    async function delReq() {
        const res_msg = await axios.get(`${process.env.REACT_APP_URL}/team/deleterequests/${ID._id}`);
        toast.success(res_msg.data); 
        history.push(`/teamprofile/${ID._id}`);
    }
            ...
            <div className={classes.heroContent1}>
                <Container maxWidth="sm">
                    ...
                    <Typography variant="h5" align="center" color="textSecondary" paragraph>
                        Add more members to your team. Share all files with them in just one click. <b>Enjoy Sharing!</b>
                    </Typography>
